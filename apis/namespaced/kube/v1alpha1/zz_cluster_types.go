...
type ClusterInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/edixos/provider-ovh/apis/namespaced/network/v1alpha1.Subnet
	...
	// +kubebuilder:validation:Optional
	NodesSubnetIDRef *v1.NamespacedReference `json:"nodesSubnetIdRef,omitempty" tf:"-"`

	// Selector for a Subnet in network to populate nodesSubnetId.
	// +kubebuilder:validation:Optional
	NodesSubnetIDSelector *v1.NamespacedSelector `json:"nodesSubnetIdSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/edixos/provider-ovh/apis/namespaced/network/v1alpha1.PrivateNetwork
