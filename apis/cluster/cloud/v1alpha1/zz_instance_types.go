...
type InstanceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/edixos/provider-ovh/apis/cluster/cloud/v1alpha1.InstanceGroup
	...
	// +crossplane:generate:reference:type=github.com/edixos/provider-ovh/apis/cluster/cloud/v1alpha1.SSHKey
	SSHKeyName *string `json:"sshKeyName,omitempty" tf:"ssh_key_name,omitempty"`

	// Reference to a SSHKey in cloud to populate sshKeyName.
	// +kubebuilder:validation:Optional
	SSHKeyNameRef *v1.Reference `json:"sshKeyNameRef,omitempty" tf:"-"`

	// Selector for a SSHKey in cloud to populate sshKeyName.
	// +kubebuilder:validation:Optional
	SSHKeyNameSelector *v1.Selector `json:"sshKeyNameSelector,omitempty" tf:"-"`
