...
func (mg *LogSubscription) GetTerraformResourceType() string {
	return "ovh_cloud_project_kube_log_subscription"
}
...
func (tr *LogSubscription) GetObservation() (map[string]any, error) {
...
func (tr *LogSubscription) SetObservation(obs map[string]any) error {
...
func (tr *LogSubscription) GetParameters() (map[string]any, error) {
...
func (tr *LogSubscription) SetParameters(params map[string]any) error {
...
// GetInitParameters of this LogSubscription
func (tr *LogSubscription) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this LogSubscription
func (tr *LogSubscription) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
