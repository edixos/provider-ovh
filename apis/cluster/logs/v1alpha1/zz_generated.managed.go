...
// GetDeletionPolicy of this LogsEncryptionKey.
func (mg *LogsEncryptionKey) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}
...
func (mg *LogsEncryptionKey) GetProviderConfigReference() *xpv1.Reference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this LogsEncryptionKey.
func (mg *LogsEncryptionKey) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}
...
// SetDeletionPolicy of this LogsEncryptionKey.
func (mg *LogsEncryptionKey) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}
...
func (mg *LogsEncryptionKey) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this LogsEncryptionKey.
func (mg *LogsEncryptionKey) SetWriteConnectionSecretToReference(r *xpv1.SecretReference) {
	mg.Spec.WriteConnectionSecretToReference = r
}
